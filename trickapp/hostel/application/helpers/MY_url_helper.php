...
if (!function_exists('array_column')) {
	 ...
	 */
        ...
        if (!function_exists('showbookStatus')) {
		function showbookStatus($text='') {
			$statusArray	=	array('issued'=>'<span class="badge badge-primary">Issued</span>',
									  'return'=>'<span class="badge badge-danger">Return</span>',
									  'B'=>'<span class="badge badge-danger">Lost</span>'
									 );
			return $statusArray[$text];
		}
	}
	 ...
	 */
        ...
        if (!function_exists('showbookcopyStatus')) {
		function showbookcopyStatus($text='') {
                    
			$statusArray	=	array('issued'=>'<span class="badge badge-warning">Issued</span>',
                            'library'=>'<span class="badge badge-primary">In Library</span>',
	...
	if (!function_exists('studentUniqueId')) {
		function studentUniqueId($studentId='') {
			return date('Y').'10000'.$studentId;
		}
	}
