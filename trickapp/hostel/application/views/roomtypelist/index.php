<ol class="breadcrumb">
  ...
  <li class="active">Manage room type details</li>
  <?php if($add_data =='Y'): ?>
  <li class="pull-right"><a href="{FULL_SITE_URL}{CURRENT_CLASS}/addeditdata" class="btn btn-default">Add room type</a></li>
  <?php endif; ?>
</ol>
{message}
      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr class="<?php if($i%2 == 0): echo 'odd'; else: echo 'even'; endif; ?>">
            ...
            <td><?=stripslashes($ALLDATAINFO['room_capacity'])?> person</td>
            <td><?=stripslashes($ALLDATAINFO['room_fee_monthly'])?> &#8377;</td>
            <td><?=stripslashes($ALLDATAINFO['room_fee_yearly'])?> &#8377;</td>
            ...
            <?php if($edit_data == 'Y' || $delete_data == 'Y' || $view_data == 'Y'): ?>
              <td><div class="btn-group"> <a class="btn btn-success dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);">Action <i class="fa fa-arrow-down icon-white"></i></a>
                  <ul class="dropdown-menu">
                    ...
                    <?php if($view_data == 'Y'): ?>
                    <li class="divider"></li>
                    <li><a href="javascript:void(0);" class="view-details-data" title="Room Type details" data-id="<?=$ALLDATAINFO['encrypt_id']?>"><i class="fa fa-gear"></i> View details</a></li>
                    <?php endif; ?>
                  </ul>
                </div>
            </td>
