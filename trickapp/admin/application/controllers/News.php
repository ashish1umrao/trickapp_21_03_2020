...
class News extends CI_Controller {
	...
	{	
		...
		$whereCon['where']		 			= 	"news.franchise_id = '".$this->session->userdata('SMS_ADMIN_FRANCHISE_ID')."' 
												 AND news.school_id = '".$this->session->userdata('SMS_ADMIN_SCHOOL_ID')."' 
												 AND news.branch_id = '".$this->session->userdata('SMS_ADMIN_BRANCH_ID')."'";		
		$shortField 						= 	'UNIX_TIMESTAMP(news.creation_date) DESC';
       ...
       if ($this->uri->segment(getUrlSegment())):
		...
		$this->layouts->set_title('Manage news details');
		$this->layouts->admin_view('news/index',array(),$data);
	}	// END OF FUNCTION
