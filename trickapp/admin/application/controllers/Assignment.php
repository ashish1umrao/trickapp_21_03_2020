...
class Assignment extends CI_Controller {
	...
	{	
		...
		$asubQuery   = "SELECT home.assignments_id,cl.class_name,sect.class_section_name,sub.subject_name,				home.assignments_title,home.assignments_content,home.assignments_file,
						home.assignments_from_date,home.assignments_to_date,home.creation_date 
						from sms_assignments home INNER JOIN sms_classes cl on home.class_id=cl.encrypt_id
       ...
       if ($this->uri->segment(getUrlSegment())):
		...
		$this->layouts->admin_view('assignment/index',array(),$data);
	}	// END OF FUNCTION
