<ol class="breadcrumb">
  ...
  <li class="active">Manage grade scale details</li>
  <?php if($add_data =='Y'): ?>
  <li class="pull-right"><a href="{FULL_SITE_URL}{CURRENT_CLASS}/addeditdata" class="btn btn-default">Add grade scale details</a></li>
  <?php endif; ?>
</ol>
{message}
      ...
      <table class="table table-striped b-t b-light">
        <thead>
          <tr>
            <th>Sr.No.</th>
            <th>Grade</th>
            <th>Grade Scale Value</th>
			<th>Lower Mark Range(in %)</th>
            <th>Upper Mark Range(in %) </th>
			<th>
        ...
        <tbody>
          ...
          <tr class="<?php if($i%2 == 0): echo 'odd'; else: echo 'even'; endif; ?>">
            ...
            <td><?=stripslashes($ALLDATAINFO['value'])?></td>
			<td><?=stripslashes($ALLDATAINFO['lower_mark'])?></td>
			<td><?=stripslashes($ALLDATAINFO['upper_mark'])?></td>
