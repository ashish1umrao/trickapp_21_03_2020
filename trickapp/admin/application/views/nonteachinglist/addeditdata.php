...
<script>
$(function(){
	$("#birth_date").datepicker({dateFormat:'dd-mm-yy',changeMonth: true,changeYear: true,  maxDate: 0 ,yearRange: "1960:<?php echo date('Y')-2; ?>"});
	$("#join_date").datepicker({dateFormat:'dd-mm-yy',changeMonth: true,changeYear: true,   maxDate: 0 ,yearRange: "1960:<?php echo date('Y'); ?>"});
});
</script>
<style>
#driverLicenceDiv { display:none;}
</style>
<ol class="breadcrumb">
  <li><a href="{FULL_SITE_URL}dashboard">Home</a></li>
  <li><a href="<?php echo correctLink('nonteachingListAdminData','{FULL_SITE_URL}{CURRENT_CLASS}/index'); ?>">Manage
       staff details</a></li>
  <li class="active">
    <?=$EDITDATA?'Edit':'Add'?>
   non teaching staff details</li>
  <li class="pull-right"><a href="<?php echo correctLink('nonteachingListAdminData','{FULL_SITE_URL}{CURRENT_CLASS}/index'); ?>" class="btn btn-default">Back</a></li>
</ol>
{message}
    ...
    <div class="col-lg-12">
      <section class="panel">
        <header class="panel-heading"> <span class="tools pull-left">
          <?=$EDITDATA?'Edit':'Add'?>
          non teaching staff  details</span> </header>
        <div class="panel-body">
          <form id="currentPageForm" method="post" class="form-horizontal" role="form" action="">
            ...
            <div class="col-lg-12">
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="col-lg-4 control-label">Non Teaching Staff Type<span class="required">*</span></label>
                <div class="col-lg-8">
                      <?php if(set_value('user_type')): $usertype	=	set_value('user_type'); elseif($EDITDATA['user_type']): $usertype	=	$EDITDATA['user_type']; else: $usertype	=	''; endif; ?>
                      <select name="user_type" id="user_type" class="form-control selectstate">
                        <option value="">Select non teaching staff type</option>
                        <?php if($USERTYPEDATA <> ""): foreach($USERTYPEDATA as $USERTYPEINFO): ?>
                        <option value="<?php echo $USERTYPEINFO['user_type_name']; ?>" <?php if($USERTYPEINFO['user_type_name'] == $usertype): echo 'selected="selected"'; endif; ?>><?php echo stripslashes($USERTYPEINFO['user_type_name']); ?></option>
            ...
            <br clear="all" />
            <fieldset>
            <legend>Staff's correspondence address</legend>
            ...
            <div class="col-lg-12" id="driverLicenceDiv">
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="col-lg-4 control-label">Driving Licence No<span class="required">*</span></label>
                  <div class="col-lg-8">
                    <input type="text" name="user_dl_no" id="user_dl_no" value="<?php if(set_value('user_dl_no')): echo set_value('user_dl_no'); else: echo stripslashes($EDITDATA['user_dl_no']);endif; ?>" class="form-control required" placeholder="Driving Licence No">
                    <?php if(form_error('user_dl_no')): ?>
                    <p for="user_dl_no" generated="true" class="error"><?php echo form_error('user_dl_no'); ?></p>
                    <?php endif; ?>
                  </div>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="col-lg-4 control-label">Driving Licence Image</label>
                  <div class="col-lg-8"> <span style="display:inline-block;" id="uploadIds1"><img class="img-responsive" src="{ASSET_URL}images/browse-white.png" border="0" alt="" /></span><br clear="all" />
                    <input type="text" id="uploadimage1" name="uploadimage1" value="<?php if(set_value('uploadimage1')): echo set_value('uploadimage1'); else: echo stripslashes($EDITDATA['user_dl_image']); endif; ?>" class="browseimageclass" />
                    <br clear="all">
                    ...
                    <?php elseif($EDITDATA['user_dl_image']):?>
                    <img src="<?php echo stripslashes($EDITDATA['user_dl_image'])?>" width="100" border="0" alt="" /> <a href="javascript:void(0);" onClick="DeleteImage('<?php echo stripslashes($EDITDATA['user_dl_image'])?>','1');"> <img src="{ASSET_URL}images/cross.png" border="0" alt="" /> </a>
                    <?php endif; ?>
                    </span> </div>
                </div>
              </div>
            ...
            <div class="form-group">
              <div class="col-lg-offset-1 col-lg-11">
                ...
                <a href="<?php echo correctLink('nonteachingListAdminData','{FULL_SITE_URL}{CURRENT_CLASS}/index'); ?>" class="btn btn-default">Cancel</a> <span class="tools pull-right"> <span class="btn btn-outline btn-default">Note
...
<script>
$(document).on('change','#currentPageForm #user_type',function(){
	var curType		=	$(this).val();
	if(curType == 'Driver'){
		$('#driverLicenceDiv').css('display','block');
	} else {
		$('#driverLicenceDiv').css('display','none');
	}
});
$(document).ready(function(){
