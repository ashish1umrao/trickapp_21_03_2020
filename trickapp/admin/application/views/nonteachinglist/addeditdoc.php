<ol class="breadcrumb">
  ...
  <li><a href="<?php echo correctLink('nonteachingListAdminData','{FULL_SITE_URL}{CURRENT_CLASS}/index'); ?>">Manage staff details </a></li>
  <li class="active">
    <?=$EDITDATA?'Edit':'Add'?>
     Upload  Documents </li>
...
<div class="form-w3layouts">
    <ul class="nav nav-tabs blue_tab">
      <li><a href="{FULL_SITE_URL}{CURRENT_CLASS}/addeditdata/<?php echo $userid; ?>">Personal</a></li>
