<ol class="breadcrumb">
  ...
  <li class="active">Manage route details</li>
  <?php if($add_data =='Y'): ?>
  <li class="pull-right"><a href="{FULL_SITE_URL}{CURRENT_CLASS}/addeditdata" class="btn btn-default">Add route details</a></li>
  <?php endif; ?>
</ol>
{message}
      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr class="<?php if($i%2 == 0): echo 'odd'; else: echo 'even'; endif; ?>">
            <td><?=$i++?></td>
            <td><?=stripslashes($ALLDATAINFO['route_name'])?></td>
            <td><?=stripslashes($ALLDATAINFO['route_short_name'])?></td>
            <td><?=stripslashes($ALLDATAINFO['total_stop'])?></td>
            <td><?=stripslashes($ALLDATAINFO['min_fee'])?></td>
            <td><?=stripslashes($ALLDATAINFO['max_fee'])?></td>
            ...
            <td><div class="btn-group"> <a class="btn btn-success dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);">Action <i class="fa fa-arrow-down icon-white"></i></a>
                  <ul class="dropdown-menu">
                    ...
                    <li class="divider"></li>
                    <li><a href="{FULL_SITE_URL}{CURRENT_CLASS}/assignvehicle/<?=$ALLDATAINFO['encrypt_id']?>"><i class="fa fa-bus"></i> Assign vehicle</a></li>
                    <li class="divider"></li>
                    ...
                    <?php if($view_data == 'Y'): ?>
                    <li class="divider"></li>
                    <?php /*?><li><a href="javascript:void(0);" class="view-details-data" title="Route details" data-id="<?=$ALLDATAINFO['encrypt_id']?>"><i class="fa fa-gear"></i> View details</a></li><?php */?>
                    <li><a href="{FULL_SITE_URL}{CURRENT_CLASS}/getviewdata/<?=$ALLDATAINFO['encrypt_id']?>" title="Route details"><i class="fa fa-gear"></i> View details</a></li>
                    <?php endif; ?>
                  </ul>
                </div>
            </td>
