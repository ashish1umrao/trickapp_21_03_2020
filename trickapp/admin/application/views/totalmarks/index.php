<ol class="breadcrumb">
  ...
  <li class="active">Manage total mark details</li>
  <?php if($add_data =='Y'): ?>
  <li class="pull-right"><a href="{FULL_SITE_URL}{CURRENT_CLASS}/addeditdata" class="btn btn-default">Add total mark details</a></li>
  <?php endif; ?>
</ol>
{message}
      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr class="<?php if($i%2 == 0): echo 'odd'; else: echo 'even'; endif; ?>">
            <td><?=$i++?></td>
            <td><?=stripslashes($ALLDATAINFO['written_exam'])?></td>
            <td><?=stripslashes($ALLDATAINFO['assessment_exam'])?></td>
			<td><?=stripslashes($ALLDATAINFO['total_mark'])?></td>
