<ol class="breadcrumb">
  ...
  <li class="active">Manage vehicle details</li>
  <?php if($add_data =='Y'): ?>
  <li class="pull-right"><a href="{FULL_SITE_URL}{CURRENT_CLASS}/addeditdata" class="btn btn-default">Add vehicle details</a></li>
  <?php endif; ?>
</ol>
{message}
      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr class="<?php if($i%2 == 0): echo 'odd'; else: echo 'even'; endif; ?>">
            <td><?=$i++?></td>
            <td><?=stripslashes($ALLDATAINFO['vehicle_no'])?></td>
            <td><?=stripslashes($ALLDATAINFO['vehicle_type_name'])?></td>
            <td><?=stripslashes($ALLDATAINFO['no_of_seat'])?></td>
            <td><?=stripslashes($ALLDATAINFO['max_seat_extend'])?></td>
