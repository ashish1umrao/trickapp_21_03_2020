                        ...
                        <div id="TOtalmoredetailsMainDiv">
                          ...
                          if(set_value('TotalmoredetailsCount')):
                            for($i=1;$i<=$TotalmoredetailsCount;$i++):
                              ...
                              $student_f_name             =   'student_f_name'.$i;
                              ...
                              $student_dob                =   'student_dob'.$i;
                              $student_image              =   'student_image'.$i;
                              $student_gender             =   'student_gender'.$i;
                              $student_visible_mark       =   'student_visible_mark'.$i;
                          ?>
                          ...
                          <?php endfor;?>
                          <?php elseif($SIBEDITDATA <> ""): ?>
                            <?php $i=1;foreach($SIBEDITDATA as $STUSIBDATAINFO): //echo "<pre>"; print_r($STUSIBDATAINFO); die;?>
						  ...
						  <div class="col-lg-12 class-parent">
								  ...
								  <div class="col-lg-6">
									<div class="form-group">
									  ...
									  <div class="col-lg-8">
										<?php if(set_value('section_id')): $sectionid = set_value('section_id'); else: $sectionid  = $EDITDATA['section_id'];  endif; ?>
										<select name="section_id_<?php echo $i;?>" id="section_id" class="form-control required">
										  <option value="">Select section name</option>
										</select>
										<?php if(form_error('section_id')): ?>
										<p for="section_id" generated="true" class="error"><?php echo form_error('section_id'); ?></p>
  ...
  $(function(){
    ...
    $(document).on('click', '#currentPageForm .removeMoredetail', function() {  
      if( CountPrice > 1 ) {
        ...
        CountPrice--;
        $('#currentPageForm #TotalPrice').val(CountPrice);
      }
      return false;
    });
    });
