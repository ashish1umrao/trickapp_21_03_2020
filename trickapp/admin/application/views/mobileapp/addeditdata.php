<ol class="breadcrumb">
  ...
  <li><a href="<?php echo correctLink('appdataAdminData','{FULL_SITE_URL}{CURRENT_CLASS}/index'); ?>">Manage
      franchising details</a></li>
  <li class="active">
    <?=$EDITDATA?'Edit':'Add'?>
    franchising details</li>
  <li class="pull-right"><a href="<?php echo correctLink('appdataAdminData','{FULL_SITE_URL}{CURRENT_CLASS}/index'); ?>" class="btn btn-default">Back</a></li>
</ol>
{message}
    ...
    <div class="col-lg-12">
      <section class="panel">
        <header class="panel-heading"> <span class="tools pull-left">
          <?=$EDITDATA?'Edit':'Add'?>
          franchising details</span> </header>
          ...
          <form id="currentPageForm" method="post" class="form-horizontal" role="form" action="">
            ...
            <div class="form-group">
              ...
              <div class="col-lg-6">
                ...
                <p for="admin_mobile_number" generated="true" class="error"><?php echo $s_mobileerror; ?></p>
                <?php endif; ?>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <div class="col-lg-offset-3 col-lg-9">
                ...
                <a href="<?php echo correctLink('appdataAdminData','{FULL_SITE_URL}{CURRENT_CLASS}/index'); ?>" class="btn btn-default">Cancel</a> <span class="tools pull-right"> <span class="btn btn-outline btn-default">Note
