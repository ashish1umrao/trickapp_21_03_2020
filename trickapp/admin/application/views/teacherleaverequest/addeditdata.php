<ol class="breadcrumb">
  ...
  <li><a href="<?php echo correctLink('teacherleaverequestAdminData','{FULL_SITE_URL}{CURRENT_CLASS}/index'); ?>">Manage
     Teacher Leave Request</a></li>
  <li class="active">
    <?=$EDITDATA?'Edit':'Add'?>
    Teacher Leave Request</li>
  <li class="pull-right"><a href="<?php echo correctLink('teacherleaverequestAdminData','{FULL_SITE_URL}{CURRENT_CLASS}/index'); ?>" class="btn btn-default">Back</a></li>
</ol>
{message}
    ...
    <div class="col-lg-12">
      <section class="panel">
        <header class="panel-heading"> <span class="tools pull-left">
          <?=$EDITDATA?'Edit':'Add'?>
          Teacher Leave Request</span> </header>
