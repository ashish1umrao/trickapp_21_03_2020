<ol class="breadcrumb">
  ...
  <li><a href="<?php echo correctLink('franchisingAdminData','{FULL_SITE_URL}{CURRENT_CLASS}/index'); ?>">Manage
      Franchisee details</a></li>
  <li class="active">
    <?=$EDITDATA?'Edit':'Add'?>
    Franchisee details</li>
  <li class="pull-right"><a href="<?php echo correctLink('franchisingAdminData','{FULL_SITE_URL}{CURRENT_CLASS}/index'); ?>" class="btn btn-default">Back</a></li>
</ol>
{message}
    ...
    <div class="col-lg-12">
      <section class="panel">
        <header class="panel-heading"> <span class="tools pull-left">
          <?=$EDITDATA?'Edit':'Add'?>
          Franchisee details</span> </header>
