<ol class="breadcrumb">
  ...
  <li class="active">Manage holiday details</li>
  <?php if($add_data =='Y'): ?>
  <li class="pull-right"><a href="{FULL_SITE_URL}{CURRENT_CLASS}/addeditdata" class="btn btn-default">Add holiday details</a></li>
  <?php endif; ?>
</ol>
{message}
      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr class="<?php if($i%2 == 0): echo 'odd'; else: echo 'even'; endif; ?>">
            ...
            <td><?=YYMMDDtoDDMMYY($ALLDATAINFO['startdate'])?></td>
             <td><?=YYMMDDtoDDMMYY($ALLDATAINFO['enddate'])?></td>
