<ol class="breadcrumb">
  ...
  <li class="active">Manage syllabus Details</li>
  
  <?php if($add_data =='Y'): ?>
  <li class="pull-right"><a href="{FULL_SITE_URL}{CURRENT_CLASS}/addeditdata" class="btn btn-default">Add syllabus </a></li>
  <?php endif; ?>
  ...
  <div class="panel panel-default">
    ...
    <div class="row w3-res-tb">
      ...
      <div class="col-sm-5 class-parent">
          ...
          <!-- <select name="subject_id" id="section_id" class="input-sm form-control  required w-sm inline v-middle">
