<ol class="breadcrumb">
  ...
  <?php if($add_data =='Y'): ?>
  <li class="pull-right"><a href="{FULL_SITE_URL}{CURRENT_CLASS}/addeditdata" class="btn btn-default">Add news details</a></li>
  <?php endif; ?>
</ol>
{message}
      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr class="<?php if($i%2 == 0): echo 'odd'; else: echo 'even'; endif; ?>">
            <td><?=$i++?></td>
            <td><?=stripslashes($ALLDATAINFO['news_title'])?></td>
            <td><?=stripslashes($ALLDATAINFO['current_year'])?></td>
            <td>
              <?php if($ALLDATAINFO['news_image']): ?>
                <img src="<?=stripslashes($ALLDATAINFO['news_image'])?>" alt="News image" width="100" />
              <?php endif; ?>
            </td>
