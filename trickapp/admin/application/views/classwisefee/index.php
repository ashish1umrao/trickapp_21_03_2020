<ol class="breadcrumb">
  ...
  <li class="active">Manage Class Wise Fee</li>
  <?php if($add_data =='Y'): ?>
  <li class="pull-right"><a href="{FULL_SITE_URL}{CURRENT_CLASS}/addeditdata" class="btn btn-default">Add Class Wise Fee</a></li>
  <?php endif; ?>
</ol>
{message}
    ...
    <div class="row w3-res-tb">
      ...
      <div class="col-sm-3">
        <div class="input-group">
          <input type="text" name="searchValue" id="searchValue" value="<?php echo $searchValue; ?>" class="input-sm form-control" placeholder="Search by name">
