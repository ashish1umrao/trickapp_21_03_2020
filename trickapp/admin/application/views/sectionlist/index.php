<ol class="breadcrumb">
  ...
  <li class="active">Manage section details</li>
  <?php if($add_data =='Y'): ?>
  <li class="pull-right"><a href="{FULL_SITE_URL}{CURRENT_CLASS}/addeditdata" class="btn btn-default">Add section details</a></li>
  <?php endif; ?>
</ol>
{message}
      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr class="<?php if($i%2 == 0): echo 'odd'; else: echo 'even'; endif; ?>">
            ...
            <td><?=stripslashes($ALLDATAINFO['class_section_short_name'])?></td>
            ...
            <td><div class="btn-group"> <a class="btn btn-success dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);">Action <i class="fa fa-arrow-down icon-white"></i></a>
                  <ul class="dropdown-menu">
                    ...
                    <?php endif; endif; 
                        if($view_data == 'Y'): ?>
                      <li class="divider"></li>
                    <li><a href="{FULL_SITE_URL}{CURRENT_CLASS}/manageperiod/<?=$ALLDATAINFO['encrypt_id']?>"><i class="fa fa-bell-o"></i> Manage Time Table</a></li>
                    <?php  endif;  ?>
                  </ul>
                </div>
            </td>
