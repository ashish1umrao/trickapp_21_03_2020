...
<ol class="breadcrumb">
  ...
  <li class="active">Manage teacher attendance details</li>
</ol>
...
<div class="table-agile-info">
  <div class="panel panel-default">
      ...
      <div class="col-sm-8 m-b-xs">
       ...
       <a class="btn btn-success "  href="{ASSET_URL}demo_doc/teacher_attendance.csv" download>Demo Upload CSV<i class="fa fa-upload" aria-hidden="true"></i></a>
      </div>
      <div class="col-sm-3"  >
        <input type="file" name="teacherFile" id="teacherFile"    accept=".csv" class="form-control required" style="height:auto;">
      </div>
      <div class="col-sm-1">
    ...
    <div class="row w3-res-tb">
      <div class="col-sm-6 m-b-xs">  
         <select name="teacher_id" id="teacher_id" class="input-sm form-control  required w-sm inline v-middle">
          ...
          <option value="All" <?php if($teacherid == 'All'){ echo  'selected="selected"'; } ?>>All</option>
          <?php  if($TEACHERDATA <> ""): foreach ($TEACHERDATA as $teachInfo): ?>
          <option value="<?php echo stripcslashes($teachInfo['encrypt_id']); ?>" <?php if($teacherid == $teachInfo['encrypt_id']){ echo  'selected="selected"'; } ?> > <?php echo stripcslashes($teachInfo['user_f_name'].' '.$teachInfo['user_m_name'].' '.$teachInfo['user_l_name']); ?></option>
