<ol class="breadcrumb">
  ...
  <li class="active">Manage gallery details</li>
  <?php if($add_data =='Y'): ?>
  <li class="pull-right"><a href="{FULL_SITE_URL}{CURRENT_CLASS}/addeditdata" class="btn btn-default">Add gallery details</a></li>
  <?php endif; ?>
</ol>
{message}
      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr class="<?php if($i%2 == 0): echo 'odd'; else: echo 'even'; endif; ?>">
            <td><?=$i++?></td>
            <td><?=stripslashes($ALLDATAINFO['gallery_name'])?></td>
            <td><?=stripslashes($ALLDATAINFO['current_year'])?></td>
            <td>
              <?php if($ALLDATAINFO['image_name']): ?>
                <img src="<?=stripslashes($ALLDATAINFO['image_name'])?>" alt="Gallery image" width="100" />
              <?php endif; ?>
            </td>
