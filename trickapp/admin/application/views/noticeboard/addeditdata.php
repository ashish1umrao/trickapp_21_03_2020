        ...
        <div class="panel-body">
          <form id="currentPageForm" method="post" class="form-horizontal" role="form" action="">
            ...
            <div class="col-lg-12">
              ...
              <div class="col-lg-10">
                <div class="form-group">
                  <label class="col-lg-4 control-label">Notice Title<span class="required">*</span></label>
                  <div class="col-lg-8">
                  <input type="text" name="notice_title" id="notice_title" value="<?php if(set_value('notice_title')): echo set_value('notice_title'); else: echo stripslashes($EDITDATA['notice_title']);endif; ?>" class="form-control required" placeholder="Notice Title">
                  <?php if(form_error('notice_title')): ?>
                  <p for="notice_title" generated="true" class="error"><?php echo form_error('notice_title'); ?></p>
                  <?php endif; ?>
                </div>
              </div>
            </div>
