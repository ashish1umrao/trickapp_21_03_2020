...
<ol class="breadcrumb">
  ...
  <li class="active">Manage fee fine</li>
  <?php if($add_data =='Y'): ?>
  <li class="pull-right"><a href="{FULL_SITE_URL}{CURRENT_CLASS}/addeditdata" class="btn btn-default">Add fee fine</a></li>
  <?php endif; ?>
</ol>
{message}
      ...
      <table class="table table-striped b-t b-light">
        <thead>
          <tr>
            ...
            <th>Fine Type</th>
            <th>Fine Amount</th>
            <th> Fine  Every Day   &#8377 </th>
            <th>Fine Upto Days </th>
        ...
        <tbody>
          ...
          <tr class="<?php if($i%2 == 0): echo 'odd'; else: echo 'even'; endif; ?>">
            ...
            <td><?=stripslashes($ALLDATAINFO['heading_type'])?></td>
               ...
               <td><?=stripslashes($ALLDATAINFO['fee_fine_type'])?>  
                   
                   </td>
                 <td><?=stripslashes($ALLDATAINFO['fee_fine_value'])?>
                 <?php  if($ALLDATAINFO['fee_fine_type'] == 'Percentage'):
                         echo '%' ;
                       
                       elseif($ALLDATAINFO['fee_fine_type'] == 'Fixed'):
                       
                           echo '&#8377' ;
                       endif;   ?>
                 
                 </td>
                   <td><?=stripslashes($ALLDATAINFO['fee_fine_every_days'])?></td>
                     <td><?=stripslashes($ALLDATAINFO['fee_fine_upto_days'])?></td>
