<ol class="breadcrumb">
  ...
  <li class="active">Manage devlopment program details</li>
  <?php if($add_data =='Y'): ?>
  <li class="pull-right"><a href="{FULL_SITE_URL}{CURRENT_CLASS}/addeditdata" class="btn btn-default">Add devlopment program details</a></li>
  <?php endif; ?>
</ol>
{message}
      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr class="<?php if($i%2 == 0): echo 'odd'; else: echo 'even'; endif; ?>">
            <td><?=$i++?></td>
            <td><?=stripslashes($ALLDATAINFO['develop_program_title'])?></td>
            <td><?=YYMMDDtoDDMMYY($ALLDATAINFO['develop_program_date'])?></td>
            <td><?=stripslashes($ALLDATAINFO['develop_program_time'])?></td>
            <td><?=$ALLDATAINFO['develop_program_speaker']=='Oteher'?stripslashes($ALLDATAINFO['develop_program_other_speaker']):stripslashes($ALLDATAINFO['develop_program_speaker'])?></td>
            <?php if($edit_data == 'Y' || $delete_data == 'Y'): ?>
