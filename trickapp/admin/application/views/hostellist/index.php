<ol class="breadcrumb">
  ...
  <li class="active">Manage hostel details</li>
  <li class="pull-right"><a href="{FULL_SITE_URL}{CURRENT_CLASS}/addeditdata" class="btn btn-default">Add hostel details</a></li>
</ol>
{message}
      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr class="<?php if($i%2 == 0): echo 'odd'; else: echo 'even'; endif; ?>">
            <td><?=$i++?></td>
            <td><?=stripslashes($ALLDATAINFO['hostel_name'])?></td>
            <td><?=stripslashes($ALLDATAINFO['hostel_total_room'])?></td>
         
             <td><?=stripslashes($ALLDATAINFO['hostel_type'])?></td>
             <td><?=stripslashes(ucwords($ALLDATAINFO['user_f_name']))?>  <?=stripslashes($ALLDATAINFO['user_m_name'])?> <?=stripslashes($ALLDATAINFO['user_l_name'])?> </td>
            ...
            <td><div class="btn-group"> <a class="btn btn-success dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);">Action <i class="fa fa-arrow-down icon-white"></i></a>
                  <ul class="dropdown-menu">
                    ...
                    <?php endif; endif; ?>
                     <?php if($view_data == 'Y'): ?>
                    <li class="divider"></li>
                    <li><a href="javascript:void(0);" class="view-details-data" title="Teacher details" data-id="<?=$ALLDATAINFO['encrypt_id']?>"><i class="fa fa-gear"></i> hostel details</a></li>
                    <?php endif; ?>
                  </ul>
                </div>
            </td>
