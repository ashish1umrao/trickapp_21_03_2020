<ol class="breadcrumb">
  ...
  <li class="active">Manage working day details</li>
  <?php if($add_data =='Y' || $edit_data =='Y'): if($ALLDATA <> ""): ?>
  <li class="pull-right"><a href="{FULL_SITE_URL}{CURRENT_CLASS}/addeditdata" class="btn btn-default">Edit working day details</a></li>
  <?php else: ?>
  <li class="pull-right"><a href="{FULL_SITE_URL}{CURRENT_CLASS}/addeditdata" class="btn btn-default">Add working day details</a></li>
  <?php endif; endif; ?>
</ol>
{message}
      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr class="<?php if($i%2 == 0): echo 'odd'; else: echo 'even'; endif; ?>">
            <td><?=$i++?></td>
            <td><?=stripslashes($ALLDATAINFO['working_day_name'])?></td>
            <td><?=stripslashes($ALLDATAINFO['working_day_short_name'])?></td>
          </tr>
          <?php endforeach; else: ?>
            <tr>
