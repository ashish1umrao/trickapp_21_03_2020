<ol class="breadcrumb">
  ...
  <li class="active">Manage Feedback Request</li>
  <?php if($add_data =='Y'): ?>
      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr class="<?php if($i%2 == 0): echo 'odd'; else: echo 'even'; endif; ?>">
            ...
            <td><?=stripslashes($ALLDATAINFO['sender_type'])?></td>
           
            <!-- <td><?=date('d/m/Y',strtotime($ALLDATAINFO['from_date']))?></td>
            <td><?=date('d/m/Y',strtotime($ALLDATAINFO['to_date']))?></td> -->
            <td><textarea rows="3"><?=stripslashes($ALLDATAINFO['message'])?></textarea></td>
            ...
            <td><div class="btn-group"> <a class="btn btn-success dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);">Action <i class="fa fa-arrow-down icon-white"></i></a>
                  <ul class="dropdown-menu">
                    <?php if($edit_data == 'Y'): ?>
                    <?php /*?><li><a href="{FULL_SITE_URL}{CURRENT_CLASS}/addeditdata/<?=$ALLDATAINFO['encrypt_id']?>"><i class="fa fa-pencil"></i> Edit details</a></li><?php */?>
                    <li class="divider"></li>
