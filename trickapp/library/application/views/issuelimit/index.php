<ol class="breadcrumb">
  ...
  <li class="active">Manage max book issue limit</li>
 <?php if($add_data =='Y'): 
     if(count($ALLDATA) < '2') :
     
     ?>
  <li class="pull-right"><a href="{FULL_SITE_URL}{CURRENT_CLASS}/addeditdata" class="btn btn-default">Add max book issue limit  </a></li>
  <?php 
      ...
      <table class="table table-striped b-t b-light">
        <thead>
          <tr>
            <th>Sr.No.</th>
            <th>Reader Type</th>
            <th>Max book issue limit to reader</th>
        ...
        <tbody>
          ...
          <tr class="<?php if($i%2 == 0): echo 'odd'; else: echo 'even'; endif; ?>">
            <td><?=$i++?></td>
            <td><?=stripslashes($ALLDATAINFO['reader_type'])?></td>
            <td><?=stripslashes($ALLDATAINFO['issue_limit'])?></td>
