<ol class="breadcrumb">
  ...
  <li class="active">Manage book category details</li>
  <?php if($add_data =='Y'): ?>
  <li class="pull-right"><a href="{FULL_SITE_URL}{CURRENT_CLASS}/addeditdata" class="btn btn-default">Add category</a></li>
  <?php endif; ?>
</ol>
{message}
