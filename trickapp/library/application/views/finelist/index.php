<ol class="breadcrumb">
  ...
  <li class="active">Manage fine details</li>
 <?php if($add_data =='Y'): 
     if(count($ALLDATA) < '3'):
     ?>
  <li class="pull-right"><a href="{FULL_SITE_URL}{CURRENT_CLASS}/addeditdata" class="btn btn-default">Add fine rule </a></li>
  <?php   endif; endif; ?>
</ol>
{message}
      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr class="<?php if($i%2 == 0): echo 'odd'; else: echo 'even'; endif; ?>">
            <td><?=$i++?></td>
            <td><?=stripslashes($ALLDATAINFO['fine_rule'])?></td>
            <td><?=stripslashes($ALLDATAINFO['fine_per_day'])?></td>
