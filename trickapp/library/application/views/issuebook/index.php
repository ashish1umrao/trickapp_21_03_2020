...
<div class="form-w3layouts">
  <div class="row">
    <div class="col-lg-12">
      ...
      <div id="bookdata"  class="col-sm-5 m-b-xs bookdata">
          
                       
      </div>
      <div class="col-sm-2">
      </div>
      <div  id="readerdata" class="col-sm-5 readerdata">
        ...
        <div class="panel-body">
          ...
          <form id="currentPageForm" method="post" class="form-horizontal" role="form" action="">
                  ...
                  <p for="barcode" generated="true" class="error"><?php echo form_error('barcode'); ?></p>
                   ...
                   elseif($barcodeError): ?>
                    <p for="barcode" generated="true" class="error"><?php echo $barcodeError; ?></p>
                     <?php    elseif($bookAissue): ?>
                    <p for="barcode" generated="true" class="error"><?php echo $bookAissue; ?></p>
                   <?php    elseif($issueLimitError): ?>
                    <p for="barcode" generated="true" class="error"><?php echo $issueLimitError; ?></p>
                    <?php endif; ?>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-6">
                <input type="text" name="reader_id" id="reader_id"value="<?php if(set_value('reader_id')): echo set_value('reader_id'); endif; ?>" class="form-control required" placeholder=" Student Registration no or Employee id">
...
$(document).ready(function(){
    $('#reader_id').change(function() {
        ...
        $.ajax({
            ...
            url: FULLSITEURL+CURRENTCLASS+'/get_reader_detail',
              type: 'POST',
