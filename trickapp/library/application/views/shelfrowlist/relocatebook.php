        ...
        <div class="panel-body">
         ...
         <div class="col-lg-12  " style="margin-top:30px;">
          ...
          <div class="form-group">
                  <label class="col-lg-6 control-label"> Current  Row No.<span class="required">*</span></label>
                  <div class="col-lg-6">
...
<div class="panel panel-default">
         ...
         <div class="col-lg-12 class-parent">
              <div class="col-lg-5">
                <div class="form-group">
                  ...
                  <div class="col-lg-6">
                    <?php if(set_value('shelf_id')): $shelfid = set_value('shelf_id'); else: $shelfid  = $shelf_id;  endif; ?>
    ...
    overflow: hidden;" >
                  ...
                  <div class="col-lg-8">
                    ...
                    <?php if(set_value('shelf_row_id')): $shelfrowid = set_value('shelf_row_id'); else: $shelfrowid  = $shelf_row_id ;  endif; ?>
                    ...
                    <?php  elseif($quntyError): ?>
                      <p for="shelf_row_id" generated="true" class="error"><?php echo $quntyError; ?></p>
                  <?php  endif; ?>
      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          <?php if($ALLDATA <> ""): $i=1; foreach($ALLDATA as $ALLDATAINFO): 
		  		//$catename		=	$this->admindata_model->get_category_name($ALLDATAINFO->category_id);
		  ?>
          <tr>
            <th scope="row" <?php if($i%2 == 0): echo 'odd'; else: echo 'even'; endif; ?>><?=$i++?>
              &nbsp;&nbsp;
              <input type="checkbox" name="DataId[]" id="DataId<?=$i?>" value="<?=$ALLDATAINFO['encrypt_id']?>" class="flat" /></th>
    ...
    <footer class="panel-footer">
      <div class="row">
          ...
          Select All</label>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span  id ="relocatemultiple" class="btn btn-primary relocatemultiple">Relocate Books</span> </span> </div>
        <div class="col-sm-5">
...
<script>
<?php if($shelf_id <> "" || $_POST): ?> 
  
$(document).ready(function(){ 
  var curobj      =   $('#shelf_row_id');
...
$(document).on('click',"#Data_Form .relocatemultiple",function(){
	var count =	0;
