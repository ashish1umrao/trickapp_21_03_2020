<ol class="breadcrumb">
  ...
  <li class="active">Manage shelf details</li>
  <?php if($add_data =='Y'): ?>
  <li class="pull-right"><a href="{FULL_SITE_URL}{CURRENT_CLASS}/addeditdata" class="btn btn-default">Add shelf </a></li>
  <?php endif; ?>
</ol>
{message}
      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr class="<?php if($i%2 == 0): echo 'odd'; else: echo 'even'; endif; ?>">
            <td><?=$i++?></td>
            <td><?=stripslashes($ALLDATAINFO['shelf'])?></td>
             <td><?=stripslashes($ALLDATAINFO['total_rows'])?></td>
              <td><?=stripslashes($ALLDATAINFO['total_books'])?></td>
            ...
            <td><div class="btn-group"> <a class="btn btn-success dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);">Action <i class="fa fa-arrow-down icon-white"></i></a>
                  <ul class="dropdown-menu">
                    ...
                    <li class="divider"></li>
                    <li><a href="{FULL_SITE_URL}{CURRENT_CLASS}/relocatebook/<?=$ALLDATAINFO['encrypt_id']?>"><i class="fa fa-book"></i> Relocate Books</a></li>
                    <li class="divider"></li>
                    ...
                    <?php endif;
                     ...
                     <li class="divider"></li>
                     <li><a href="javascript:void(0);" class="view-details-data" title="Shelf Details" data-id="<?=$ALLDATAINFO['encrypt_id']?>"><i class="fa fa-gear"></i> View details</a></li>
                  </ul>
                </div>
            </td>
            <?php endif; ?>
