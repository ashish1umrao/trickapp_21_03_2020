<ol class="breadcrumb">
  ...
  <li class="active">Manage book details</li>
  <?php if($add_data =='Y'): ?>
  <li class="pull-right"><a href="{FULL_SITE_URL}{CURRENT_CLASS}/addeditdata" class="btn btn-default">Add book details</a></li>
  <?php endif; ?>
</ol>
{message}
    ...
    <div class="table-responsive">
      <table class="table table-striped b-t b-light">
        ...
        <td><?=stripslashes($ALLDATAINFO['book_quantity'])?></td>
              <td><?=stripslashes($ALLDATAINFO['book_quantity'] - ($ALLDATAINFO['book_issued'] + $ALLDATAINFO['book_lost']) )?></td>
            ...
            <td><div class="btn-group"> <a class="btn btn-success dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);">Action <i class="fa fa-arrow-down icon-white"></i></a>
                  <ul class="dropdown-menu">
                    ...
                    <li><a href="{FULL_SITE_URL}{CURRENT_CLASS}/addeditdata/<?=$ALLDATAINFO['encrypt_id']?>"><i class="fa fa-pencil"></i> Edit details</a></li>
                     <li class="divider"></li>
                       <li><a href="{FULL_SITE_URL}{CURRENT_CLASS}/addcopy/<?=$ALLDATAINFO['encrypt_id']?>"><i class="fa fa-barcode"></i> Add copy & Generate barcode</a></li>
                    <li class="divider"></li>
                    ...
                    <?php endif; endif; ?>
                     <li class="divider"></li>
                     <li><a href="{FULL_SITE_URL}{CURRENT_CLASS}/bookcopy/<?=$ALLDATAINFO['encrypt_id']?>"><i class="fa fa-file-o"></i> View Book copies </a></li>
                      <li class="divider"></li>
                     <li><a href="javascript:void(0);" class="view-details-data" title="Book Details" data-id="<?=$ALLDATAINFO['encrypt_id']?>"><i class="fa fa-gear"></i> View details</a></li>
