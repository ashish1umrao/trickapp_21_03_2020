<ol class="breadcrumb">
  ...
  <li><a href="<?php echo correctLink('bookcopyListAdminData','{FULL_SITE_URL}{CURRENT_CLASS}/index'); ?>">Manage
      book details</a></li>
  <li class="active">
    
    Manage book copies</li>
      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr class="<?php if($i%2 == 0): echo 'odd'; else: echo 'even'; endif; ?>">
            ...
            <?php if($edit_data == 'Y' || $delete_data == 'Y'): ?>
              <td><div class="btn-group"> <a class="btn btn-success " href="{FULL_SITE_URL}{CURRENT_CLASS}/downloadbarcode/<?=$ALLDATAINFO['barcode']?>/<?=$book_id?>">Download Barcode <i class="fa fa-download icon-white"></i></a>
